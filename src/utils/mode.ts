...
export const  GAMES_MODE = [
    //BRAIN
    { id: 0, identifier: "reactiontime", type: SearchType.GAME, subtype: GameModeType.BRAIN, image: reactiontime, translationKey: "reactiontime", created_at: new Date(2026,2,18) },
    { id: 0, identifier: "sequencememory", type: SearchType.GAME, subtype: GameModeType.BRAIN, image: visualmemory, translationKey: "sequencememory", created_at: new Date(2026,3,18) },
    //{ id: 0, identifier: "aimtrainer", type: SearchType.GAME, subtype: GameModeType.BRAIN, image: aimtrainer, translationKey: "aimtrainer", created_at: new Date(2026,3,18) },
    { id: 0, identifier: "numbermemory", type: SearchType.GAME, subtype: GameModeType.BRAIN, image: numbermemory, translationKey: "numbermemory", created_at: new Date(2026,2,18) },
